...
// ---- Affiche les bouttons
	addPageMenu($corefolder,$mod,"Rechercher",geturl("forum","recherche","critere=".$critere),"icn32_rechercher.png");
	if (GetDroit("CreeClasseur"))
	{
		addPageMenu($corefolder,$mod,"Nouveau classeur",geturl("forum","editer","fid=0&fpars=0&fprec=liste"),"icn32_nouveau.png");
	}
	addPageMenu($corefolder,$mod,"Marquer comme lus",geturl("forum","","fonc=marquer"),"icn32_valider.png");
